...
public class ConexionBD {
    ...
    private String nombreBD = "diccionario";//basemysql
    private String hostBD = "localhost";//localhost
    private String databaseBD = "mysql";//mysql
    private String puertoBD = "3306";//3306
